...
void baseMesh::draw(glm::vec3 &_lightLocation, glm::vec3 &_lightAttenuation, glm::vec3 &_cameraLocation)
{
...
void baseMesh::scaleMesh(float scaleAmount)
{
    ...
    if (scaleAmount > 0)
    {
        for (vector<glm::vec3>::iterator i = originalVertices.begin(); i != originalVertices.end(); ++i)
        {
