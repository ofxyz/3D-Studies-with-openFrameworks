...
void testApp::setup()
{
    ...
    mesh->addColors(151, 150, 144, 150);
    mesh->scaleMesh(0.5);
    ...
    mesh = new baseMesh();
    mesh->setupImportMesh("/Users/alptugan/oF/assets/model/PirateBoy.mtl", false);
    mesh->addColors(151, 150, 144, 150);
    mesh->scaleMesh(1.12);
    
    //import mesh using .mtl file
    mesh = new baseMesh();
    mesh->setupImportMesh("/Users/alptugan/oF/assets/model/PirateBoy.mtl", true);
    mesh->addColors(0, 0, 0, 150); //colors are not necessary, but alpha (the last argument) is
    mesh->scaleMesh(1.12);
}
...
void testApp::draw()
{
    ...
    lightAttenuation = glm::vec3(pointLight.getAttenuationConstant(), pointLight.getAttenuationLinear(), pointLight.getAttenuationQuadratic());
